...
from layers.Attention import AttentionLayer, RotaryAttention
from layers.Embeding import PowerGCTEmbedding
...
class Model(nn.Module):
    def __init__(self, configs, patch_len=16, stride=16):
        ...
        self.patch_embedding = PowerGCTEmbedding(
        ...
        self.encoder = Encoder(
            [
                EncoderLayer(
                    AttentionLayer(
                        RotaryAttention(False, configs.factor, attention_dropout=configs.dropout,
        ...
        self.loc_projection = DenseNet(layer_num=(4, 8, 4, 2), growth_rate=1, in_channels=1, classes=configs.seq_len+1)
